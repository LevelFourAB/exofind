...
@Schema(
	...
	examples = StringFieldDefinition.EXAMPLE,
	...
	public record TextUsage(
		...
		@Schema(
			description = """
				...
				length thresholds.""",
			examples = TypoTolerance.EXAMPLE
		)
		public record TypoTolerance(
			...
			/** The example usage, as the JSON a caller writes. */
			public static final String EXAMPLE = """
				{ "minLengthOneTypo": 5, "minLengthTwoTypos": 9, "prefixLength": 1 }""";
