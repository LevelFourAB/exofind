...
public interface Location {
	...
	default MergedLocation mergeWith(Location other) {
		return new MergedLocation(Lists.immutable.of(this, other));
	}
	 ...
	 *
	 * @return instance representing the best known location
	 */
	 ...
	 *
	 * @return instance representing the best known location, never {@code null}
	 */
	 ...
	 *
	 * @param picked location to maybe use, may be {@code null}
	 * @return instance representing the best known location, never {@code null}
	 */
