#!/usr/bin/env bash
#
# Load the airport example into a node: define the index, put every airport
# in it and commit, which is what makes them searchable and pushes them to
# storage.
#
...
# in batches rather than as one post of every airport there is.
BATCH="${BATCH:-5000}"
