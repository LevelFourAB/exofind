#!/usr/bin/env bash
#
# Load the Cleveland Museum example into a node: define the index, put every
# object in it and commit, which is what makes them searchable and pushes them
# to storage.
#
...
# in batches rather than as one post of every object there is.
BATCH="${BATCH:-5000}"
