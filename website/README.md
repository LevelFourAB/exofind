...
`/api/` holds an overview and a page per endpoint, generated by
[`src/openapi/`](src/openapi/) from
...
Five modules read the document and four components draw it. Each states its own
